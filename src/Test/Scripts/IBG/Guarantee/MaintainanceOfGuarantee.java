...
public class MaintainanceOfGuarantee extends BaseClass {
    ...
    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "ExternalAmendToGuarantee")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitDeal("ExternalAmendToGuarantee");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "InternalAmendToGuarantee")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("InternalAmendToGuarantee");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "ExpiryOfGuarantee")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("ExpiryOfGuarantee");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "RefundOfCharges")
    public void RefundOfCharges(Map<String, String> testData) throws IOException{
        ...
        PageObject.switchToChildWindow();
        driver.manage().window().maximize();
        PageObject.textinput_Locator("transactionId","MD133480033101");
        PageObject.img_Button("Edit a contract");
        PageObject.switchToChildWindow();
        PageObject.textinput_Locator("fieldName:CHARGE.CODE:1",testData.get("CHARGE.CODE"));
        PageObject.textinput_Locator("fieldName:CHARGE.DATE:1",testData.get("CHARGE.DATE"));
        PageObject.textinput_Locator("fieldName:CHARGE.SEQUENCE:1",testData.get("CHARGE.SEQUENCE"));
        PageObject.textinput_Locator("fieldName:CHARGE.ACCOUNT:1",testData.get("CHARGE.ACCOUNT"));
        PageObject.textinput_Locator("fieldName:CHARGE.CURRENCY:1",testData.get("CHARGE.CURRENCY"));
        PageObject.textinput_Locator("fieldName:TOT.CHARGE.AMT:1",testData.get("TOT.CHARGE.AMT"));
        PageObject.textinput_Locator("fieldName:CHARGE.AMT:1",testData.get("CHARGE.AMT"));
        PageObject.textinput_Locator("fieldName:REALISED.AMT:1",testData.get("REALISED.AMT"));
        PageObject.textinput_Locator("fieldName:UNREALISED.AMT:1",testData.get("UNREALISED.AMT"));
        PageObject.textinput_Locator("fieldName:REFUND.DATE:1",testData.get("REFUND.DATE"));
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("RefundOfCharges");
