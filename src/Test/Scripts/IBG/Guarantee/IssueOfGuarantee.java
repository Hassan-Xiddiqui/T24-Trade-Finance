...
public class IssueOfGuarantee extends BaseClass {
    ...
    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "BeneficiaryCustomer")
    public void BeneficiaryCustomer(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Open Beneficiary Customer");
        ...
        PageObject.textinput_Locator("fieldName:SHORT.NAME:1",testData.get("SHORT.NAME"));
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitDeal("BeneficiaryCustomer");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "IssueOfGenericGuarantee")
    public void IssueOfGenericGuarantee(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Issue of Guarantees");
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("IssueOfGenericGuarantee");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "BacktoBackGuarantee")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("BacktoBackGuarantee");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "ForeignGuarantee")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("ForeignGuarantee");
    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "SBLCForeignGuarantee")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("SBLCForeignGuarantee");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "ReIssueGenericGuarantee")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("ReIssueGenericGuarantee");
