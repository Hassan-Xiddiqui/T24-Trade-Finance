...
public class GuaranteeReceived extends BaseClass {

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "GuaranteeReceivedGeneric")
    public void GuaranteeReceivedGeneric(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Guarantee Received",1);
        PageObject.menu_Link("Guarantee Received-Generic ");
        ...
        PageObject.commitDeal("GuaranteeReceivedGeneric");


    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "AmendToGuaranteeReceived")
    public void AmendToGuaranteeReceived(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Guarantee Received",1);
        PageObject.menu_Link("Amendment to Guarantee Received ");
        PageObject.switchToChildWindow();
        driver.manage().window().maximize();
        PageObject.img_Button("New Deal");
        PageObject.switchToChildWindow();
        ...
        PageObject.textinput_Locator("fieldName:MD.NARR.MSG",testData.get("MD.NARR.MSG"));
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("AmendToGuaranteeReceived");
    ...
    @DataProvider(name = "GuaranteeReceivedGeneric")
    ...
    @DataProvider(name = "AmendToGuaranteeReceived")
