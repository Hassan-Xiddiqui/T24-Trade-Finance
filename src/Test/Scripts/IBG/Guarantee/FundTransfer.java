...
public class FundTransfer extends BaseClass {
    ...
    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "FTBWAccounts")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitDeal("FTBWAccounts");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "FTGeneral")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("FTGeneral");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "FTPLCategories")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("FTPLCategories");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "ReturnComissionPL")
    public void ReturnComissionPL(Map<String, String> testData) throws IOException{
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("ReturnComissionPL");

    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "FTPaymentReceive")
    public void FTPaymentReceive(Map<String, String> testData) throws IOException{
        ...
        PageObject.textinput_Locator("fieldName:COMMISSION.TYPE:1",testData.get("COMMISSION.TYPE"));
        PageObject.textinput_Locator("fieldName:COMMISSION.AMT:1",testData.get("COMMISSION.AMT"));
        PageObject.textinput_Locator("fieldName:TREASURY.RATE","");
        PageObject.textinput_Locator("fieldName:CUSTOMER.SPREAD","");
        PageObject.textinput_Locator("fieldName:CUSTOMER.RATE","");
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("FTPaymentReceive");


    }

    @Test(groups = {"IBGGuaranteeInputter"}, dataProvider = "FTChargesPayment")
