...
public class FICHARGE extends BaseClass {

    @Test(groups = {"IBGExportInputter"}, dataProvider = "FIIssuanceCharges")
    public void FIIssuanceCharges(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("FI.CHARGE",1);
        PageObject.menu_Link("FI Issuance Charges ");
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitDeal("FIIssuanceCharges");


    }

    @Test(groups = {"IBGExportInputter"}, dataProvider = "FITransferCharges")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
    ...
    @DataProvider(name = "FITransferCharges")
