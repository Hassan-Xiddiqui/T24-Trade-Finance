...
public class ExportLC extends BaseClass {

    @Test(groups = {"IBGExportInputter"}, dataProvider = "SightLC")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
    ...
    @Test(groups = {"IBGExportInputter"}, dataProvider = "UsanceLC")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("UsanceLC");
