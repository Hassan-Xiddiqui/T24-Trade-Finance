...
public class AuthoriseDeleteMT103Transact extends BaseClass {
    ...
    public void AuthoriseDeleteAdvancePayment(Map<String, String> testData) throws IOException{
        ...
        PageObject.menu_Dropdown("Authorise / Delete MT103 Transactions",1);
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
    ...
    @Test(groups = {"IBGExportInputter"}, dataProvider = "PaymentTransferChargesforMT202MT103")
    public void PaymentTransferChargesforMT202MT103(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("MT103 Confirmation - PSW",1);
        PageObject.menu_Link("Payment Transfer Charges for MT202/MT103 ");
        PageObject.switchToChildWindow();
        driver.manage().window().maximize();
        PageObject.img_Button("New Deal");
        PageObject.switchToChildWindow();
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("PaymentTransferChargesforMT202MT103");
    ...
    @DataProvider(name = "PaymentTransferChargesforMT202MT103")
