...
public class ManualFIIssuanceCancelExport extends BaseClass {
    ...
    public void SendManualFIExport(Map<String, String> testData) throws IOException{
        ...
        PageObject.menu_Link("Send Manual FI - Export ");
...
//        PageObject.textinput_Locator("fieldName:DEPT.CODE",testData.get("DEPT.CODE"));
    ...
    @Test(groups = {"IBGExportInputter"}, dataProvider = "ManualFIUpdateExport")
...
//        PageObject.textinput_Locator("fieldName:DEPT.CODE",testData.get("DEPT.CODE"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("ManualFIUpdateExport");

    }

    @Test(groups = {"IBGExportInputter"}, dataProvider = "CancelFIExport")
...
//        PageObject.textinput_Locator("fieldName:DEPT.CODE",testData.get("DEPT.CODE"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("CancelFIExport");
    ...
    @DataProvider(name = "ManualFIUpdateExport")
    ...
    @DataProvider(name = "CancelFIExport")
