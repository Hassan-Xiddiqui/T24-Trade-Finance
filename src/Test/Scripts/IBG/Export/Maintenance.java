...
public class Maintenance extends BaseClass {
    ...
    @Test(groups = {"IBGExportInputter"}, dataProvider = "ExternalAmendment")
    public void ExternalAmendment(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Maintenance",2);
...
//        PageObject.textinput_Locator("fieldName:ACUDOLLAR",testData.get("ACUDOLLAR"));
        ...
        PageObject.textinput_Locator("fieldName:LATEST.SHIPMENT",testData.get("LATEST.SHIPMENT"));
        PageObject.textinput_Locator("fieldName:SHIPMENT.PERIOD:1",testData.get("SHIPMENT.PERIOD"));
        PageObject.textinput_Locator("fieldName:PART.SHIP.TEXT",testData.get("PART.SHIP.TEXT"));
        PageObject.textinput_Locator("fieldName:TRANSSHIPMENTS",testData.get("TRANSSHIPMENTS"));
        ...
        PageObject.textinput_Locator("fieldName:EXTERNAL.REFERENCE",testData.get("EXTERNAL.REFERENCE"));
        PageObject.textinput_Locator("fieldName:ISSUE.DATE",testData.get("ISSUE.DATE"));
        //PageObject.textinput_Locator("fieldName:AMENDMENT.DTE",testData.get("AMENDMENT.DTE"));
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitDeal("ExternalAmendment");



    }

    @Test(groups = {"IBGExportInputter"}, dataProvider = "InternalAmendment")
    public void InternalAmendment(Map<String, String> testData) throws IOException{
...
//        PageObject.textinput_Locator("fieldName:LMT.FOR.REVOLVING",testData.get("LMT.FOR.REVOLVING"));
//        PageObject.textinput_Locator("fieldName:CUR.REVOL.LIAB",testData.get("CUR.REVOL.LIAB"));
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("InternalAmendment");
    ...
    @DataProvider(name = "ExternalAmendment")
    ...
    @DataProvider(name = "InternalAmendment")
