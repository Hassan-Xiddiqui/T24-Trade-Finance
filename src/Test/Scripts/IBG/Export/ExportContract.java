...
public class ExportContract extends BaseClass {
    ...
    @Test(groups = {"IBGExportInputter"}, dataProvider = "RegisterExportContract")
...
//        PageObject.textinput_Locator("fieldName:CO.CODE",testData.get("CO.CODE"));
        ...
        PageObject.commitDeal("RegisterExportContract");

    }

    @Test(groups = {"IBGExportInputter"}, dataProvider = "AmendExportContract")
...
//        PageObject.textinput_Locator("fieldName:CO.CODE",testData.get("CO.CODE"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("AmendExportContract");
    ...
    @Test(groups = {"IBGExportInputter"}, dataProvider = "LodgeDocumentsAgainstExportContract")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("LodgeDocumentsAgainstExportContract");
...
//        PageObject.textinput_Locator("fieldName:DEPT.CODE",testData.get("DEPT.CODE"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("AmendLodgeDocsExpContract");

    }

    @Test(groups = {"IBGExportInputter"}, dataProvider = "RejectDocumentsReversalCollection")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("RejectDocumentsReversalCollection");

    }

    @Test(groups = {"IBGExportInputter"}, dataProvider = "PaymentOfExportContract")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("PaymentOfExportContract");
