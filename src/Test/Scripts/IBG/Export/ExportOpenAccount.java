...
public class ExportOpenAccount extends BaseClass {

    @Test(groups = {"IBGExportInputter"}, dataProvider = "LodgeExportOpenAccount")
    public void LodgeExportOpenAccount(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Export Open Account",1);
        PageObject.menu_Link("Lodge Export Open Account ");
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitDeal("LodgeExportOpenAccount");


    }

    @Test(groups = {"IBGExportInputter"}, dataProvider = "AmendLodgeDocsExpOpenAccount")
    public void AmendLodgeDocsExpOpenAccount(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Export Open Account",1);
        PageObject.menu_Link("Amend Lodge Docs Exp Open Account ");
        PageObject.switchToChildWindow();
        driver.manage().window().maximize();
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("AmendLodgeDocsExpOpenAccount");


    }

    @Test(groups = {"IBGExportInputter"}, dataProvider = "ExportOpenAccountPayment")
    public void ExportOpenAccountPayment(Map<String, String> testData) throws IOException{
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("ExportOpenAccountPayment");
    ...
    @DataProvider(name = "LodgeExportOpenAccount")
    ...
    @DataProvider(name = "AmendLodgeDocsExpOpenAccount")
    ...
    @DataProvider(name = "ExportOpenAccountPayment")
