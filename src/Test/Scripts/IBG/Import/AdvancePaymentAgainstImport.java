...
public class AdvancePaymentAgainstImport extends BaseClass {
    ...
    @Test(groups = {"IBGImportInputter"}, dataProvider = "ImportAdvancePayment")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
    ...
    @Test(groups = {"IBGImportInputter"}, dataProvider = "RepatriateImportAdvancePayment")
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("RepatriateImportAdvancePayment");
    }
    @Test(groups = {"IBGImportInputter"}, dataProvider = "DocRegisterAgainstImportAdvancePayment")
    public void DocRegisterAgainstImportAdvancePayment (Map<String, String> testData) throws IOException{
        ...
        PageObject.textinput_Locator("fieldName:TRANS.DOC:1",testData.get("TRANS.DOC"));
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitTxn();
        PageObject.commitDeal("DocRegisterAgainstImportAdvancePayment");
    ...
    @DataProvider(name = "DocRegisterAgainstImportAdvancePayment")
