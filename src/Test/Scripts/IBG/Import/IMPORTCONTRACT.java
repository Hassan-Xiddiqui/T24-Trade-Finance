...
public class IMPORTCONTRACT extends BaseClass {

    @Test(groups = {"IBGImportInputter"}, dataProvider = "REGISTERIMPORTCONTRACT IMPORT CONTRACT")
    public void REGISTERIMPORTCONTRACT(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Import Contract",1);
...
//        PageObject.commitDeal("REGISTERIMPORTCONTRACT");
