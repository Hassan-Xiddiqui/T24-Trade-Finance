...
public class ImportDocumentaryCollection extends BaseClass {

    @Test(groups = {"IBGImportInputter"}, dataProvider = "LodgmentOfInwardCollection")
    public void LodgmentOfInwardCollection (Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Import Documentary Collection",1);
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
        ...
        PageObject.commitDeal("LodgmentOfInwardCollection");
    ...
    @Test(groups = {"IBGImportInputter"}, dataProvider = "LodgmentOfInwardCollection")
    public void OnlineMaturityOfInwardCollection (Map<String, String> testData) throws IOException{
