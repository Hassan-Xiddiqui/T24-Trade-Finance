...
public class GuaranteeLetters extends BaseClass {
    ...
    @Test(groups = {"GuaranteeInputter"}, dataProvider = "RegisterClaimUnderGuarantee")
    ...
    @Test(groups = {"GuaranteeInputter"}, dataProvider = "AssignmentLetterOtherBank")
    ...
    @Test(groups = {"GuaranteeInputter"}, dataProvider = "AssignmentLetterOurBank")
