...
public class ManualFIIssuance extends BaseClass {

    @Test(groups = {"ImportInputter"}, dataProvider = "SendManualFIImport")
    public void SendManualFIImport(Map<String, String> testData) throws IOException {

        PageObject.menu_Dropdown("Manual FI Issuance And Cancellation");
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "ManualFIUpdateImport")
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "ManualFICancellation")
    public void ManualFICancellation(Map<String, String> testData) throws IOException{
    ...
    @DataProvider(name = "ManualFICancellation")
