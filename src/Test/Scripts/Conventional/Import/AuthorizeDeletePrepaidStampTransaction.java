...
public class AuthorizeDeletePrepaidStampTransaction extends BaseClass {

    @Test(groups = {"ImportInputter"}, dataProvider = "AuthDelPrepaidTransaction")
    public void AuthDelPrepaidTransaction(Map<String, String> testData) throws IOException {

        PageObject.menu_Dropdown("FRANKLIN MACHINE");
        PageObject.menu_Link("Authorize/Delete Prepaid Stamp Transaction ");
...
//        PageObject.textinput_Locator("fieldName:DEBIT.CURRENCY",testData.get("DEBIT.CURRENCY"));
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "AuthDelPrepaidExpTransaction")
    public void AuthDelPrepaidExpTransaction(Map<String, String> testData) throws IOException{


        PageObject.menu_Dropdown("FRANKLIN MACHINE");
        PageObject.menu_Link("Authorize/Delete Prepaid Expense Transaction ");
        PageObject.switchToChildWindow();
        driver.manage().window().maximize();
        PageObject.img_Button("New Deal");
        PageObject.switchToChildWindow();
...
//        PageObject.textinput_Locator("fieldName:AUDIT.DATE.TIME",testData.get("AUDIT.DATE.TIME"));
    ...
    @DataProvider(name = "AuthDelPrepaidTransaction")
    ...
    @DataProvider(name = "AuthDelPrepaidExpTransaction")
