...
public class FRANKLINMACHINE extends BaseClass {

    @Test(groups = {"ImportInputter"}, dataProvider = "FRANKLINMACHINE")
    public void FRANKLINMACHINE(Map<String, String> testData) throws IOException{
