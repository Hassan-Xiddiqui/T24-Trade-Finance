...
public class ImportAdvancePayment extends BaseClass {

    @Test(groups = {"Inputter"}, dataProvider = "ImportAdvancePayment")
    ...
    @Test(groups = {"Inputter"}, dataProvider = "DOCRegister")
    ...
    @Test(groups = {"Inputter"}, dataProvider = "RepatriateImportAdvancePayment")
