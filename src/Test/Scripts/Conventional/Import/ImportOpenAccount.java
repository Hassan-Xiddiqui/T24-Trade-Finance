...
public class ImportOpenAccount extends BaseClass {
    @Test(groups = {"ImportInputter"}, dataProvider = "PaymentOPAC")
    public void PaymentOPAC(Map<String, String> testData) throws IOException{
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "ImportOpenAccountMargin")
    public void ImportOpenAccountMargin(Map<String, String> testData) throws IOException{
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "ImportOpenAccountPayment")
    public void ImportOpenAccountPayment(Map<String, String> testData) throws IOException{
        ...
        PageObject.textinput_Locator("radio:tab1:SEND.PSW",testData.get("tab1"));
        PageObject.textinput_Locator("fieldName:PSW.REFERENCE",testData.get("PSW.REFERENCE"));
        //PageObject.textinput_Locator("fieldName:FND.REALIZATION","N/a");
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "ImportOpenAccountPaymentWithoutMargin")
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "LodgeImportOpenAcct")
    public void LodgeImportOpenAcct(Map<String, String> testData) throws IOException{
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "ImportOpenAccountPaymentWithoutMargin")
    public void ImportOpenAccountOtherBank(Map<String, String> testData) throws IOException {
    ...
    @DataProvider(name = "ImportOpenAccountMargin")
    ...
    @DataProvider(name = "ImportOpenAccountPayment")
    ...
    @DataProvider(name = "LodgeImportOpenAcct")
    ...
    @DataProvider(name = "ImportOpenAccountOtherBank")
