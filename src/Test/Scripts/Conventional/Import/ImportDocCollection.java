...
public class ImportDocCollection extends BaseClass {


        @Test(groups = {"ImportInputter"}, dataProvider = "LodgmentOfInwardCollection")
        public void LodgmentOfInwardCollection(Map<String, String> testData) throws IOException{

            PageObject.menu_Dropdown("Import Documentary Collection");
            PageObject.menu_Link("Lodgment Of Inward Collection ");
            ...
            PageObject.textinput_Locator("radio:tab3:CHARGES.FROM",testData.get("tab3"));
            ...
            PageObject.textinput_Locator("radio:tab4:COV.NOTE.POL",testData.get("tab4"));
            ...
            PageObject.textinput_Locator("radio:tab4:BASIS.INS",testData.get("tab4"));
            PageObject.textinput_Locator("fieldName:RISK.COV",testData.get("RISK.COV"));
            PageObject.textinput_Locator("radio:tab4:RISK.COV",testData.get("tab4"));
            PageObject.textinput_Locator("fieldName:GOODS.COV",testData.get("GOODS.COV"));
            PageObject.textinput_Locator("radio:tab4:GOODS.COV",testData.get("tab4"));
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "AcceptanceUnderInwardCollection")
    public void AcceptanceUnderInwardCollection(Map<String, String> testData) throws IOException {

        PageObject.menu_Dropdown("Import Documentary Collection");
        PageObject.menu_Link("Acceptance Under Inward Collection ");
        PageObject.switchToChildWindow();
        driver.manage().window().maximize();
    ...
    @Test(groups = {"ImportInputter"}, dataProvider = "OnlineMaturityInwardCollection")
    public void OnlineMaturityInwardCollection(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Import Documentary Collection");
        PageObject.menu_Link("Online Maturity Of Inward Collection ");
        PageObject.switchToChildWindow();
        driver.manage().window().maximize();
        PageObject.textinput_Locator("transactionId","TF1922800080");
        PageObject.img_Button("Edit a contract");
    ...
    private static final String FILE_PATH = "path/to/your/excel/Payment.xlsx"; // Update with your file path
    @DataProvider(name = "LodgmentOfInwardCollection")
    ...
    @DataProvider(name = "AcceptanceUnderInwardCollection")
    ...
    @DataProvider(name = "OnlineMaturityInwardCollection")
