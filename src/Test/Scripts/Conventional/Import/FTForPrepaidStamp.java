...
public class FTForPrepaidStamp extends BaseClass {

    @Test(groups = {"ImportInputter"}, dataProvider = "FTForPrepaidStamp")
    public void FTForPrepaidStamp(Map<String, String> testData) throws IOException {

        PageObject.menu_Dropdown("FRANKLIN MACHINE");
        PageObject.menu_Link("FT For Prepaid Stamp ");
