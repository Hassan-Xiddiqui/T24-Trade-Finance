...
public class MT103ManualTradeAdjustmentContract extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "ManualTradeAdjustmentContract")
    public void ManualTradeAdjustmentContract(Map<String, String> testData) throws IOException {
