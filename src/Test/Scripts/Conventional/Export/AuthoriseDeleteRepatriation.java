...
public class AuthoriseDeleteRepatriation extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "AuthoriseDeleteRepatriation")
    public void AuthoriseDeleteRepatriation(Map<String, String> testData) throws IOException{
        ...
        PageObject.menu_Link("Authorise / Delete Repatriation ");
