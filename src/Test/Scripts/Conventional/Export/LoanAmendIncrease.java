...
public class LoanAmendIncrease extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "LoanAmendIncrease")
    public void LoanAmendIncrease(Map<String, String> testData) throws IOException {

        PageObject.menu_Dropdown("Rupee Base Discounting", 1);
        PageObject.menu_Link("Loan Amend Increase ");
        ...
        PageObject.textinput_Locator("fieldName:ERF.EFORM.NO:1",testData.get("ERF.EFORM.NO"));
        PageObject.textinput_Locator("fieldName:COMPLETION.DATE",testData.get("COMPLETION.DATE"));
        PageObject.textinput_Locator("fieldName:PROJECT.REF.NO",testData.get("PROJECT.REF.NO"));
