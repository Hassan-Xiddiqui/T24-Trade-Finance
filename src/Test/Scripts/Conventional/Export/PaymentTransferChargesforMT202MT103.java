...
public class PaymentTransferChargesforMT202MT103 extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "PaymentTransferCharges")
    public void PaymentTransferCharges(Map<String, String> testData) throws IOException {
