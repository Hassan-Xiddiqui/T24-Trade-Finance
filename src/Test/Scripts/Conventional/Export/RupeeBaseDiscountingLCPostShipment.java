...
public class RupeeBaseDiscountingLCPostShipment extends BaseClass {


    @Test(groups = {"ExportInputter"}, dataProvider = "RupeeBaseDiscountingLCPost")
    public void RupeeBaseDiscountingLCPost(Map<String, String> testData) throws IOException {

        PageObject.menu_Dropdown("Rupee Base Discounting", 1);
        PageObject.menu_Link("Rupee Base Discounting LC - Post Shipment ");
        PageObject.switchToChildWindow();
        driver.manage().window().maximize();
        PageObject.img_Button("New Deal");
        PageObject.switchToChildWindow();
        PageObject.textinput_Locator("fieldName:DR.REF",testData.get("DR.REF"));
        ...
        PageObject.textinput_Locator("fieldName:BUS.DAY.DEFN:1",testData.get("BUS.DAY.DEFN"));
