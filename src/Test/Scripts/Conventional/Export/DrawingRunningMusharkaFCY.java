...
public class DrawingRunningMusharkaFCY extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "DrawingRunningMusharkaFCY")
    public void DrawingRunningMusharkaFCY(Map<String, String> testData) throws IOException{
