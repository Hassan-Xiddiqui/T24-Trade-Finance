...
public class AmendLodgeDocsExpOpenAccount extends BaseClass {

    @Test(groups = {"Inputter"}, dataProvider = "AmendLodgeDocsExp")
    public void AmendLodgeDocsExp(Map<String, String> testData) throws IOException {
