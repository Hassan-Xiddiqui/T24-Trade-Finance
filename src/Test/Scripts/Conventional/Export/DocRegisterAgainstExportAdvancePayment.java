...
public class DocRegisterAgainstExportAdvancePayment extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "DocRegAgainstExpAdvPay")
    public void DocRegAgainstExpAdvPay(Map<String, String> testData) throws IOException{
