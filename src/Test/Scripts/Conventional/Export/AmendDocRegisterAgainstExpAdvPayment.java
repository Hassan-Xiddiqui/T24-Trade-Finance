...
public class AmendDocRegisterAgainstExpAdvPayment extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "AmendDocReg")
    public void AmendDocReg(Map<String, String> testData) throws IOException {
