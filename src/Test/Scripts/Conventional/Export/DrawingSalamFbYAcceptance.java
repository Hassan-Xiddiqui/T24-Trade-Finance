...
public class DrawingSalamFbYAcceptance extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "DrawingSalamFbYAcceptance")
    public void DrawingSalamFbYAcceptance(Map<String, String> testData) throws IOException{
