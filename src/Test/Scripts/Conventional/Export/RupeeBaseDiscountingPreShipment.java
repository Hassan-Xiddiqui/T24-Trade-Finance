...
public class RupeeBaseDiscountingPreShipment extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "RupeeBaseDiscountingPre")
    public void RupeeBaseDiscountingPre(Map<String, String> testData) throws IOException{

        PageObject.menu_Dropdown("Rupee Base Discounting",1);
        PageObject.menu_Link("Rupee Base Discounting - Pre Shipment ");
        ...
        PageObject.textinput_Locator("fieldName:VALUATION.DATE",testData.get("VALUATION.DATE"));
        PageObject.textinput_Locator("fieldName:FIN.MAT.DATE",testData.get("FIN.MAT.DATE"));
        PageObject.textinput_Locator("fieldName:INT.RATE.TYPE",testData.get("INT.RATE.TYPE"));
        ...
        PageObject.textinput_Locator("fieldName:EXPTR.DIR.IND",testData.get("EXPTR.DIR.IND"));
        PageObject.textinput_Locator("radio:tab1:EXPTR.DIR.IND",testData.get("tab1"));
        ...
        PageObject.textinput_Locator("fieldName:BASE.DATE.KEY",testData.get("BASE.DATE.KEY"));
        PageObject.textinput_Locator("radio:tab1:BASE.DATE.KEY",testData.get("tab1"));
