...
public class FullRepayment extends BaseClass {


    @Test(groups = {"ExportInputter"}, dataProvider = "FullRepayment")
    public void FullRepayment(Map<String, String> testData) throws IOException {

        PageObject.menu_Dropdown("Rupee Base Discounting", 1);
        PageObject.menu_Link("Full Repayment ");
