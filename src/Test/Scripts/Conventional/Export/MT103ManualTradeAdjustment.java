...
public class MT103ManualTradeAdjustment extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "ManualTradeAdjustment")
    public void ManualTradeAdjustment(Map<String, String> testData) throws IOException{
