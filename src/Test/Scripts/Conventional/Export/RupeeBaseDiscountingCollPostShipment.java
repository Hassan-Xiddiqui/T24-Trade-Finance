...
public class RupeeBaseDiscountingCollPostShipment extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "RupeeBaseDiscountingPost")
    public void RupeeBaseDiscountingPost(Map<String, String> testData) throws IOException {

        PageObject.menu_Dropdown("Rupee Base Discounting", 1);
        PageObject.menu_Link("Rupee Base Discounting Coll - Post Shipment ");
        ...
        PageObject.textinput_Locator("",testData.get("undefined"));
        PageObject.textinput_Locator("fieldName:OUR.REMARKS:1",testData.get("OUR.REMARKS"));
