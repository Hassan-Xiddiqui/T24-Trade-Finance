...
public class DrawingAcceptanceOfDocuments extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "DrawingAcceptanceOfDocuments")
    public void DrawingAcceptanceOfDocuments(Map<String, String> testData) throws IOException{
        ...
        PageObject.textinput_Locator("fieldName:DRAWING.TYPE",""); // This field is mandatory but missing in Excel file.
