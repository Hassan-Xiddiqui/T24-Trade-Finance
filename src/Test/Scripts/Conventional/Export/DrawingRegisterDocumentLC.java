...
public class DrawingRegisterDocumentLC extends BaseClass {
    @Test(groups = {"ExportInputter"}, dataProvider = "DrawingRegisterDocumentLC")
    public void DrawingRegisterDocumentLC(Map<String, String> testData) throws IOException{
