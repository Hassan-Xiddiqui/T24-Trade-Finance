...
public class DocRegisterExpAdvPayOtherBankGD extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "DocRegExpAdvPayOthBankGD")
    public void DocRegExpAdvPayOthBankGD(Map<String, String> testData) throws IOException{
