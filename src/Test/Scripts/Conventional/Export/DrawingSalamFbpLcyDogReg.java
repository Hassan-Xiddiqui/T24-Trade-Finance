...
public class DrawingSalamFbpLcyDogReg extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "DrawingSalamFbpLcyDogReg")
    public void DrawingSalamFbpLcyDogReg(Map<String, String> testData) throws IOException{
