...
public class ExportSightLC extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "ExportSightLC")
    public void ExportSightLC(Map<String, String> testData) throws IOException {
