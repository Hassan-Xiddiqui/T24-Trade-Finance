...
public class MT103ManualTradeAdjustmentOPAC extends BaseClass {

    @Test(groups = {"ExportInputter"}, dataProvider = "ManualTradeAdjustmentOPAC")
    public void ManualTradeAdjustmentOPAC(Map<String, String> testData) throws IOException {
        ...
        PageObject.textinput_Locator("fieldName:BENEF.CUST:2",testData.get("BENEF.CUST"));
        PageObject.textinput_Locator("fieldName:BENEF.CUST:3",testData.get("BENEF.CUST"));
        PageObject.textinput_Locator("fieldName:BENEF.CUST:4",testData.get("BENEF.CUST"));
